(() => {
  ...
  const arabic = new Map([
    ...
    ["Private contact", "تواصل خاص"],
    ["Private correspondence", "للمراسلات الخاصة"],
    ["General inquiries", "الاستفسارات العامة"],
    ["Start a conversation", "ابدأ محادثة"],
    ["Code & projects", "البرمجة والمشاريع"],
    ["Repositories & experiments", "المستودعات والتجارب"],
    ["Data workspace", "مساحة البيانات"],
    ["Notebooks & datasets", "دفاتر العمل ومجموعات البيانات"],
    ...
    ["Curiosity in motion", "فضولٌ يقود المسيرة"],
    ["Purpose in every step", "وهدفٌ في كل خطوة"],
    ...
    ["Continue the journey", "تابع المسيرة"]
  ]);
  ...
  const translatedAttributes = [
    ...
    ["[data-close-workshop][aria-label]", "aria-label", "العودة إلى الملف"],
    ...
    [".contact-card-private", "aria-label", "راسل محمد بشكل خاص عبر thismieo@outlook.com"],
    [".contact-card-general", "aria-label", "راسل محمد عبر thismieo@gmail.com"],
    [".contact-card-github", "aria-label", "افتح حساب محمد على GitHub"],
    [".contact-card-kaggle", "aria-label", "افتح حساب محمد على Kaggle"]
  ];
  ...
  const touchLayout = window.matchMedia("(max-width: 700px), (hover: none), (pointer: coarse)").matches;
  ...
  toggle?.addEventListener("click", async () => {
    ...
    if (touchLayout) {
      const surface = document.body.classList.contains("workshop-open")
        ? document.querySelector("[data-workshop-view]")
