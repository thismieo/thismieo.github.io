MOHAMMED MUAYAD — PORTFOLIO LEVEL 5 · CHARCOAL NIGHT · VERSION 1.5
====================================
...
Notes
-----
- This is a standalone preview and does not modify the live GitHub website.
...
- Mobile and desktop keep the lightweight reading-progress line and accessible back-to-top control; the mobile control has no shadow and uses a single passive scroll listener.
- SEO metadata, social sharing metadata, structured Person data, favicon assets, robots.txt, and sitemap.xml are included.

Design direction
----------------
Charcoal Night · Smoke gradients · Quiet modern glow.

Version concept
---------------
This Level 5 edition keeps the proven Level 4 layout and moves it into a calm
night palette with charcoal gradients, soft waves, and restrained cool accents.
Version 1.5 adds the site's identity and discoverability layer, plus The Workshop
as a living record of understood concepts, applied AI work, and upcoming study.
