...
# Make the opened slot's outer layout size explicit. The visual size is unchanged;
# this only avoids WebKit deferring propagation of a tall child into document height.
